...
DIST_BASE="/home/anya/code/sae_borzoi_1/models/conv1d_1_noabs_4_topk0.05_lr1e-05/node_seqs_test_1000"
...
for NODE_ID in $NODE_IDS; do
    ...
    ln -sf "$DIST_BASE/$NODE_ID.fa" "$PROJ_DIR/data_l1/$NODE_ID/loci.fa"

done

DIST_BASE1="/home/anya/code/sae_borzoi_1/models/conv1d_1_noabs_4_topk0.05_lr1e-05/node_act_dists_test"
...
for NODE_ID in $NODE_IDS; do
    ...
    # Create symlinks to MEME files
    ln -sf "$DIST_BASE1/$NODE_ID.npy" "$PROJ_DIR/data_l1/$NODE_ID/dist_acts.npy"
