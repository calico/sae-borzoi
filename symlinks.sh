...
TOMTOM_BASE="/home/anya/code/sae_borzoi_4/models/conv1d_4_noabs_4_topk0.05_lr1e-05/meme_analysis_results/20250523_110054/tomtom_test_archetype_out"
...
for NODE_ID in $NODE_IDS; do
    ...
    ln -sf "$MEME_BASE/$NODE_ID/logo1.png" "$PROJ_DIR/data_l4/$NODE_ID/logo1.png"
